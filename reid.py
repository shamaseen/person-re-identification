import sys
sys.path.append('./BoT-SORT/deep-person-reid/')
...
class REID:
    def __init__(self):
        ...
        torchreid.utils.load_pretrained_weights(self.model, './BoT-SORT/pretrained/osnet_ain_x1_0_msmt17_256x128_amsgrad_ep50_lr0.0015_coslr_b64_fb10_softmax_labsmth_flip_jitter.pth')
        if self.use_gpu:
